...
class Ships {
    ...
    init() {
        let server = ServerUrl.Server[UserDefaults.standard.integer(forKey: DataManagement.DataName.Server)]
        shipsAPI = "https://api.worldofwarships." + server + "/wows/encyclopedia/ships/?application_id=***ApplicationID***&fields=tier%2Ctype%2Cship_id%2Cmodules%2Cdescription%2Cis_premium%2Cname%2Cnation%2Cprice_credit%2Cprice_gold%2Cimages.small" + Language.getLanguageString()
    }
