...
class Shipinformation {
    ...
    init() {
        shipInfoAPI = "https://api.worldofwarships.\(server)/wows/encyclopedia/ships/?application_id=***ApplicationID***&fields=name%2Ctype%2Ctier%2Cnation%2Cimages.small" + Language.getLanguageString()
    }
