...
class Shipinformation {
    ...
    init() {
        shipInfoAPI = "https://api.worldofwarships.\(server)/wows/encyclopedia/ships/?application_id=4e54ba74077a8230e457bf3e7e9ae858&fields=name%2Ctype%2Ctier%2Cnation%2Cimages.small%2C" + Language.getLanguageString(Mode: Language.Index.API)
    }
